...
{
	HRESULT hResult;
	GFX_THROW_FAILED(DirectX::CreateDDSTextureFromFileEx(gfx.pDevice.Get(), name,0, D3D11_USAGE_DEFAULT, D3D11_BIND_SHADER_RESOURCE, 0, D3D11_RESOURCE_MISC_TEXTURECUBE, DirectX::DX11::DDS_LOADER_DEFAULT, nullptr, pTextureView.GetAddressOf()));
}
