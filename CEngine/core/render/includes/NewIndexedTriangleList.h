...
public:
	...
	NewIndexedTriangleList(CubeR::VertexBuffer verts_in, std::vector<unsigned short> indices_in)
		:
	...
	{
		using Elements = CubeR::VertexLayout::ElementType;
